...
class AddNewCar2Fragment : BaseFragment<AddNewCarView2Model>() {
    ...
    private var vehicleEventList: ArrayList<VehicleEvent>? = null
    ...
    override fun initUi() {
        ...
        cta.setOnClickListener {
            ...
            val vehicleEvents = ArrayList<VehicleEvent>()
    ...
    override fun setObservers() {
        ...
        viewModel.actionStream.observe(viewLifecycleOwner) {
            when (it) {
                ...
                is AddNewCarView2Model.ACTION.ShowError -> Toast.makeText(
                    requireContext(),
                    it.error,
                    Toast.LENGTH_SHORT
                ).show()
