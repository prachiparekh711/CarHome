...
@HiltViewModel
class InsNaturalViewModel @Inject constructor(
    ...
    internal fun onEdit(personDetail: NaturalPersonDetails, verifyNaturalItem: VerifyRcaPerson) {
                ...
                object : BundleProvider() {
                    override fun onAddArgs(bundle: Bundle?): Bundle {
                        return Bundle().apply {
                            ...
                            putSerializable(
                                AddNewNaturalPersonFragment.ARG_VERIFY_ITEM,
                                verifyNaturalItem
                            )
                        }
                    }
