...
@HiltViewModel
class BridgeTaxSelectViewModel @Inject constructor(
    ...
    internal fun onStartWithNew() {
        uiEventStream.value = UiEvent.Navigation(NavAttribs(Screen.BridgeTaxInit))
    }
            ...
            UiEvent.Navigation(NavAttribs(Screen.BridgeTaxInit, object : BundleProvider() {
                override fun onAddArgs(bundle: Bundle?): Bundle {
                    return Bundle().apply {
                        ...
                        putSerializable(BridgeTaxInitFragment.ARG_CAR, selectedCar)
                    }
                }
            }))
    }
